...
const Banner = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#003459] to-[#fdfdfd] rounded-[20px] p-5 overflow-hidden font-sans">
      <img
      ...
      <img
        ...
        alt="Girl with Dog"
        className="w-full md:w-1/2 max-w-[513px] z-10"
      />
      <div className="text-[#003459] p-5 max-w-[500px] z-10">
        ...
        <p className="font-medium text-[14px] md:text-[12px] leading-[20px] md:leading-[18px] text-[#242b33] mb-5">
